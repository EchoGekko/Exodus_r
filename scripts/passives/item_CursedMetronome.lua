...
pExodus:AddModCallback(ModCallbacks.MC_ENTITY_TAKE_DMG, pExodus.cursedMetronomeDamage, { EntityType.ENTITY_PLAYER })
...
pExodus:AddModCallback(ModCallbacks.MC_EVALUATE_CACHE, pExodus.cursedMetronomeCache, CacheFlag.CACHE_LUCK)