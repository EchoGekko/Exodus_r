...
function pExodus.pigBloodAdd()
	local player = Isaac.GetPlayer(0)

    for i = 1, 3 do
        Isaac.Spawn(EntityType.ENTITY_PICKUP, PickupVariant.PICKUP_HEART, HeartSubType.HEART_FULL, Isaac.GetFreeNearPosition(player.Position, 50), pExodus.NullVector, nil)
    end
end
