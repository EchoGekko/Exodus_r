...
pExodus:AddModCallback(ModCallbacks.MC_POST_UPDATE, pExodus.cobaltNecklaceUpdate)
...
pExodus:AddModCallback(ModCallbacks.MC_POST_NEW_ROOM, pExodus.cobaltNecklaceNewRoom)
...
pExodus:AddModCallback(ModCallbacks.MC_EVALUATE_CACHE, pExodus.cobaltNecklaceCache, CacheFlag.CACHE_DAMAGE)
...
pExodus:AddModCallback(ModCallbacks.MC_POST_RENDER, pExodus.cobaltNecklaceRender)