...
pExodus:AddModCallback(ModCallbacks.MC_POST_UPDATE, pExodus.dadsBootsUpdate)
...
pExodus:AddModCallback(ModCallbacks.MC_ENTITY_TAKE_DMG, pExodus.dadsBootsDamage, { EntityType.ENTITY_PLAYER })
...
pExodus:AddModCallback(ModCallbacks.MC_EVALUATE_CACHE, pExodus.dadsBootsCache, CacheFlag.CACHE_SPEED)