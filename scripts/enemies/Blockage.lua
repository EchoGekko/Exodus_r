...
function pExodus.blockageEntityUpdate(entity, data)
	...
	if entity.Type == Entities.BLOCKAGE.id and entity.Variant == Entities.BLOCKAGE.variant then
...
pExodus:AddCallback(ModCallbacks.MC_NPC_UPDATE, pExodus.blockageEntityUpdate)